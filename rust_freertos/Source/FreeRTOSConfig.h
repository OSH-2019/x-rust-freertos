...
// Note by Fan Jinhao.
// Actually, these two functions are included by default. 
#define INCLUDE_xTimerGetTimerDaemonTaskHandle	1 // (timer.h, 493; timer.c, 460)
#define INCLUDE_pcTaskGetTaskName				1 // (task.h, 1331; tasks.c, 2181)
